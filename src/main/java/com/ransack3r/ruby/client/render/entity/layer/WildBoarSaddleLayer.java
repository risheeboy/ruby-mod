package com.ransack3r.ruby.client.render.entity.layer;
...
public class WildBoarSaddleLayer extends LayerRenderer<WildBoarEntity, PigModel<WildBoarEntity>> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(Rubymod.MOD_ID, "textures/entity/wild_boar/wild_boar_saddle.png");
